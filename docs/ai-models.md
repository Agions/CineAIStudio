...
| **Claude Sonnet 4** | Anthropic 主力旗舰，超长上下文 | ⭐⭐⭐⭐ |
...
# 应用内设置：设置 → AI 配置 → Anthropic → Claude Sonnet 4
```
...
| **高预算 >$50/月** | GPT-4o | Claude Sonnet 4 | OpenAI TTS |
...
- **2026.02**: Claude Sonnet 4，Gemini 3 Flash 为推荐性价比方案
