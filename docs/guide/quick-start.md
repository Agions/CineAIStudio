---
title: 5 分钟快速开始
description: 最简化的 VideoForge 上手指引，5 分钟内完成从安装到第一个 AI 视频创作。
---

# 5 分钟快速开始

> ⏱️ 如果你已经熟悉视频编辑工具，可以直接跳到 [安装 VideoForge](#快速安装)。

本指南将带你用 **5 分钟** 完成 VideoForge 的安装与首次 AI 视频创作。
...
1. 打开 [GitHub Releases](https://github.com/Agions/VideoForge/releases/latest)
2. 下载对应平台的最新版本：

| 平台 | 安装包 |
|------|--------|
| Windows | `VideoForge-Setup-x.x.x.exe` |
| macOS | `VideoForge-x.x.x.dmg` |
| Linux | `VideoForge-x.x.x.AppImage` |
...
VideoForge 支持多种 AI 提供商，只需配置一个即可使用全部功能：
...
启动 VideoForge 后，进入 **设置 → AI 配置**，粘贴你的 API Key。
...
VideoForge 需要 FFmpeg 处理视频。安装方法：
