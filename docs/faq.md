...
ClipFlowCut 已迁移至 PySide6，您可以自由用于商业项目。
...
### Q: ClipFlowCut 可以商业使用吗？

A: **可以！** ClipFlowCut 使用 MIT 许可证，PySide6 使用 LGPL 许可证，均允许商业使用。
...
- [问题反馈](https://github.com/Agions/ClipFlowCut/discussions)
