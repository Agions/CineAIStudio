---
title: 贡献指南
description: 如何参与 VideoForge 的开发、报告问题和完善文档。
---

# 贡献指南

感谢你愿意为 VideoForge 贡献力量！无论是报告 Bug、提交代码还是完善文档，每一份贡献都让这个项目变得更好。 🎉
...
| 方式 | 说明 | 入口 |
|------|------|------|
| 🐛 报告 Bug | 帮助我们发现和修复问题 | [GitHub Issues](https://github.com/Agions/VideoForge/issues/new?template=bug_report.md) |
| 💡 功能建议 | 提出新功能想法 | [Feature Request](https://github.com/Agions/VideoForge/issues/new?template=feature_request.md) |
...
# 访问 https://github.com/Agions/VideoForge 点击 Fork
...
# 访问 https://github.com/Agions/VideoForge 点击 "Compare & pull request"
```

### Commit 规范

VideoForge 遵循 [Conventional Commits](https://www.conventionalcommits.org/) 规范：
...
| 渠道 | 用途 |
|------|------|
| [GitHub Issues](https://github.com/Agions/VideoForge/issues) | Bug 报告、功能请求 |
| [GitHub Discussions](https://github.com/Agions/VideoForge/discussions) | 提问、讨论 |
