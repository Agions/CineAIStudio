...
class ProjectSettingsManager(QObject):
    ...
    def __init__(self, config_manager: ConfigManager):
        ...
        # 设置文件路径
        self.settings_file = os.path.expanduser("~/Narrafiilm/settings/project_settings.json")
        self.profiles_file = os.path.expanduser("~/Narrafiilm/settings/profiles.json")
