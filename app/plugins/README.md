...
ClipFlowCut 插件系统是一个功能强大的扩展架构，允许开发者创建和集成自定义的视频编辑功能、效果、导出格式等。插件系统基于模块化设计，支持热加载、依赖管理和安全沙箱。
...
- 插件开发文档: https://docs.ClipFlowCut.com/plugins
- 插件示例库: https://github.com/aieditx/plugin-examples
- 开发者论坛: https://forum.ClipFlowCut.com
