...
class ChatBubble(QWidget):
    ...
    def _setup_ui(self, role: str, content: str, timestamp):
        ...
        # 内容
        content_label = MacLabel(content, self)
        content_label.setProperty("class", "chat-content")
        ...
        time_label = MacLabel(time_str, self)
        time_label.setProperty("class", "text-xs text-muted")
...
class ChatInputArea(QWidget):
    ...
    def _setup_ui(self):
        ...
        input_layout = input_container.layout()
...
class SettingsPanel(QWidget):
    ...
    def _create_info_row(self, label: str, value: str, theme: str = "neutral"):
        ...
        label_widget = MacLabel(label)
        value_widget = MacLabel(value)
...
class AIChatPage(BasePage):
    ...
    def _init_ui(self):
        """初始化UI"""
        # Use existing layout from BasePage instead of creating a new one
        layout = self.layout()
