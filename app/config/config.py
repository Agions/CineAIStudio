...
class AppConfig:
    ...
    def __post_init__(self):
        ...
        if not self.app_data_dir:
            import os
            self.app_data_dir = os.path.join(os.path.expanduser("~"), ".CineFlow")
        ...
        if not self.default_project_dir:
            import os
            self.default_project_dir = os.path.join(os.path.expanduser("~"), "Documents", "CineFlow")

        if not self.default_export_dir:
            import os
            self.default_export_dir = os.path.join(os.path.expanduser("~"), "Videos", "CineFlow")
