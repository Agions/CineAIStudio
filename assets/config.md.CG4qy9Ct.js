import{_ as a,o as i,c as n,ae as l}from"./chunks/framework.Kan8UQCl.js";const c=JSON.parse('{"title":"配置参考","description":"Narrafiilm 配置文件详解和环境变量参考。","frontmatter":{"title":"配置参考","description":"Narrafiilm 配置文件详解和环境变量参考。"},"headers":[],"relativePath":"config.md","filePath":"config.md"}'),p={name:"config.md"};function t(h,s,e,k,r,d){return i(),n("div",null,[...s[0]||(s[0]=[l(`<h1 id="配置参考" tabindex="-1">配置参考 <a class="header-anchor" href="#配置参考" aria-label="Permalink to &quot;配置参考&quot;">​</a></h1><p>Narrafiilm 支持灵活的配置文件和环境变量配置。</p><h2 id="配置文件" tabindex="-1">配置文件 <a class="header-anchor" href="#配置文件" aria-label="Permalink to &quot;配置文件&quot;">​</a></h2><h3 id="目录结构" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构" aria-label="Permalink to &quot;目录结构&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>~/.narrafiilm/</span></span>
...
<span class="line"><span>└── logs/                # 日志文件</span></span></code></pre></div><h3 id="主配置文件" tabindex="-1">主配置文件 <a class="header-anchor" href="#主配置文件" aria-label="Permalink to &quot;主配置文件&quot;">​</a></h3><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># ~/.narrafiilm/config.yaml</span></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">  temp_dir</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">/tmp/narrafiilm</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  </span></span>
