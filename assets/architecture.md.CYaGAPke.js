import{_ as n,o as s,c as e,ag as t}from"./chunks/framework.8qlNDhri.js";const g=JSON.parse('{"title":"架构概览","description":"Voxplore 系统架构和技术设计的核心要点速查。","frontmatter":{"title":"架构概览","description":"Voxplore 系统架构和技术设计的核心要点速查。"},"headers":[],"relativePath":"architecture.md","filePath":"architecture.md","lastUpdated":1776522580000}'),p={name:"architecture.md"};function l(i,a,d,r,c,o){return s(),e("div",null,[...a[0]||(a[0]=[t(`<h1 id="架构概览" tabindex="-1">架构概览 <a class="header-anchor" href="#架构概览" aria-label="Permalink to &quot;架构概览&quot;">​</a></h1><p>本文档帮助你快速理解 Voxplore 的核心系统架构。</p><hr><h2 id="系统架构" tabindex="-1">系统架构 <a class="header-anchor" href="#系统架构" aria-label="Permalink to &quot;系统架构&quot;">​</a></h2><p>Voxplore 采用 <strong>三层模块化架构</strong>：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>┌──────────────────────────────────────────────────────────────┐</span></span>
...
<span class="line"><span>└──────────────────────────────────────────────────────────────┘</span></span></code></pre></div><p><strong>设计原则</strong>：UI 层与业务逻辑完全解耦，可以独立替换 UI 框架而不影响核心功能。</p><hr><h2 id="目录结构" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构" aria-label="Permalink to &quot;目录结构&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Voxplore/</span></span>
