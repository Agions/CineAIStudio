import{_ as n,o as s,c as e,ag as t}from"./chunks/framework.8qlNDhri.js";const g=JSON.parse('{"title":"架构概览","description":"Narrafiilm 系统架构和技术设计的核心要点速查。","frontmatter":{"title":"架构概览","description":"Narrafiilm 系统架构和技术设计的核心要点速查。"},"headers":[],"relativePath":"architecture.md","filePath":"architecture.md","lastUpdated":1776505423000}'),p={name:"architecture.md"};function i(l,a,d,r,c,o){return s(),e("div",null,[...a[0]||(a[0]=[t(`<h1 id="架构概览" tabindex="-1">架构概览 <a class="header-anchor" href="#架构概览" aria-label="Permalink to &quot;架构概览&quot;">​</a></h1><p>本文档帮助你快速理解 Narrafiilm 的核心系统架构。</p><hr><h2 id="系统架构" tabindex="-1">系统架构 <a class="header-anchor" href="#系统架构" aria-label="Permalink to &quot;系统架构&quot;">​</a></h2><p>Narrafiilm 采用 <strong>三层模块化架构</strong>：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>┌──────────────────────────────────────────────────────────────┐</span></span>
