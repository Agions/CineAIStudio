...
def main() -> int:
    ...
    try:
        ...
        qt_app.setApplicationName("CineFlow")
        ...
        logger.info(f"应用程序配置: CineFlow v{config.version}")
...
def show_splash_screen():
    ...
    try:
        ...
        painter.drawText(pixmap.rect(), Qt.AlignmentFlag.AlignCenter, "CineFlow")
